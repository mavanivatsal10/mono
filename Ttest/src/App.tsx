  ...
  const formSchema = z.object({
    productDetails: z.array(
      z.object({
        ...
        productTitle: z
          .object({
            value: z.enum(["", "milk", "mayo", "cheese"]),
            label: z.string(),
          })
          .refine((val) => val.value !== "", "Please select a product title"),
        productType: z
          .object({
            value: z.enum(["", "dairy", "snack"]),
            label: z.string(),
          })
          .refine((val) => val.value !== "", "Please select a product type"),
        productStatus: z
          .object({
            value: z.enum(["available", "unavailable"]),
            label: z.string(),
          })
          .optional(),
        taxBracket: z
          .object({ value: z.enum(["", "12", "18", "28"]), label: z.string() })
          .optional(),
